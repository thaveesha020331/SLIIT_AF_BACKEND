...
const AdminReviewsPage = () => {
  ...
  const load = async () => {
    ...
    if (token === 'admin-token-hardcoded') {
      setError('Reviews require a real backend connection. Please log in with a real admin account.');
      setLoading(false);
      return;
    }
    ...
    <div className="product-review-container">
      <div className="product-review-header">
        <div className="product-review-header-title">
          ...
          <p>
            Admin view of every product review submitted by users. Use filters to quickly
              ...
              filteredReviews.map((r) => (
                <tr key={r._id || r.id}>
                  ...
                  <td className="px-4 py-3 align-top text-gray-900">
                    ...
                    {r.productCategory && (
                      <div className="text-xs text-gray-500">{r.productCategory}</div>
                    )}
                  </td>
                  <td className="px-4 py-3 align-top text-gray-900">
                  ...
                  <td className="px-4 py-3 align-top text-gray-900">
                    {r.title || <span className="text-xs text-gray-400">—</span>}
                  </td>
                  <td className="px-4 py-3 align-top text-gray-900">
